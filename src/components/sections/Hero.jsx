      ...
      <div className="absolute inset-0 z-[4] flex items-center">
        <div className="w-full max-w-3xl px-[var(--content-pad)]">
          ...
          <div className="hero-cta flex flex-col sm:flex-row items-start gap-4 mb-6">
            ...
            <a href="tel:+9779851031257" className="inline-flex items-center gap-2 font-sans font-medium text-terra-400 border border-terra-500/50 rounded-full px-6 py-3.5 hover:border-terra-500 hover:bg-terra-500/[0.08] transition-all">
