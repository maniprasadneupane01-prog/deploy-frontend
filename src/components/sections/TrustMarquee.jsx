...
export default function TrustMarquee() {
  ...
  return (
    <div className="bg-terra-500 py-5 overflow-hidden">
      <div className="marquee-track flex gap-12 items-center" style={{ animation: 'marquee 25s linear infinite', width: 'max-content' }}>
        {doubled.map((item, i) => (
          <span key={i} className="font-sans font-semibold text-white text-sm tracking-[0.05em] whitespace-nowrap flex items-center gap-12">
            {item}
